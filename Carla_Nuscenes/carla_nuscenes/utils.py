...
#     # Translation: flip Y (CARLA left-hand → right-hand)
#     translation = [
#         transform.location.x,
#         -transform.location.y,   # ← correct Y flip
#         transform.location.z
#     ]

#     if mode == "zxy":
#         # Camera: CARLA XYZ → nuScenes ZXY
...
#         ])
#     else:
#         # LiDAR / ego / annotation: only flip Y axis
#         R_convention = np.array([
#             [1, 0, 0],
#             [0, -1, 0],
#             [0, 0, 1]
...
#     R_carla = np.array(transform.get_matrix())[:3, :3]
    
#     # ✅ Only ONE Y-flip — applied as basis change
#     # Correct: R_convention @ R_carla @ R_convention.T
#     # This properly transforms the rotation from CARLA to nuScenes frame
#     rotation_matrix = R_convention @ R_carla @ R_convention.T
